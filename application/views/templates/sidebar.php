        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #1f1f1f;">
          ...
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>">
            ...
            <div class="sidebar-brand-text mx-3 text-left">Rywiza <br>Book</div>
          </a>
