...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-6 mx-auto">
      ...
      <?php } ?>
      <?= $this->session->flashdata('pesan'); ?>
      <a href="" class="btn btn-dark mb-3" data-toggle="modal" data-target="#kategoriBaruModal"><i class="fas fa-file-alt"></i> Tambah Kategori</a>
    ...
    <div class="modal-content">
      ...
      <form action="<?= base_url('buku/kategori'); ?>" method="post">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-danger" data-dismiss="modal"><i class="fas fa-ban"></i> Close</button>
          <button type="submit" class="btn btn-dark"><i class="fas fa-plus-circle"></i> Tambah</button>
        </div>
      </form>
    </div>
  </div>
